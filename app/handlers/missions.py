...
from app.models.missions import finish_mission, today_missions
...
async def complete(update, context):
    ...
    await update.message.reply_text(
        "✅ مأموریت ثبت شد. امتیاز اضافه شد.", reply_markup=main_menu()
    )
...
missions_conv = ConversationHandler(
    ...
    states={1: [MessageHandler(filters.TEXT & ~filters.COMMAND, complete)]},
